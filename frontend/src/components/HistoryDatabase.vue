          ...
          <div class="modal-content">
            ...
            <div class="modal-actions">
              ...
              >
                ...
                <span class="btn-icon">◈</span>
                <span class="btn-text">環境セットアップ</span>
              </button>
              <button 
            ...
            <div class="modal-playback-hint">
              <span class="hint-text">Step3「シミュレーション開始」と Step5「深層インタラクション」は実行中に起動する必要があり、履歴再生はサポートされていません</span>
            </div>
          </div>
        </div>
      </Transition>
...
const getSimulationTitle = (requirement) => {
  if (!requirement) return '名称未設定のシミュレーション'
