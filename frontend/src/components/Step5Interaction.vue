          ...
          <div class="action-bar-tabs">
            ...
            <div class="agent-dropdown" v-if="profiles.length > 0">
              ...
              >
                ...
                <span>{{ selectedAgent ? selectedAgent.username : 'シミュレーション世界の任意エージェントと対話' }}</span>
              ...
              <div v-if="showAgentDropdown" class="dropdown-menu">
                ...
                >
                  ...
                  <div class="agent-info">
                    ...
                    <span class="agent-role">{{ agent.profession || '職業不明' }}</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div v-if="activeTab === 'chat'" class="chat-container">
          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">レポート生成エージェントの高速対話版。4種の専門ツールを呼び出し可能でMiroFishの完全な記憶を保有</div>
              </div>
              ...
              <div class="tools-grid">
                <div class="tool-item tool-purple">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">InsightForge 深層帰因分析</div>
                    <div class="tool-desc">現実世界シードデータとシミュレーション環境状態を整合させ、Global/Local Memoryメカニズムで時空を超えた深層帰因分析を提供</div>
                  </div>
                </div>
                <div class="tool-item tool-blue">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">グラフ構造の幅優先アルゴリズムでイベント伝播経路を再構成し、全情報フローのトポロジー構造を捕捉</div>
                  </div>
                </div>
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">GraphRAGベースのリアルタイムクエリインターフェース。インデックス効率を最適化し、ノード属性と個別事実を高速に抽出</div>
                  </div>
                </div>
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">自律型インタビュー。シミュレーション世界の個体と並行して複数回対話し、非構造化意見データと心理状態を収集</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="profile-card-header">
              ...
              <div class="profile-card-info">
                ...
                <div class="profile-card-meta">
                  ...
                  <span class="profile-card-profession">{{ selectedAgent.profession || '職業不明' }}</span>
                </div>
              </div>
          ...
          <div class="chat-messages" ref="chatMessages">
            <div v-if="chatHistory.length === 0" class="chat-empty">
              ...
              <p class="empty-text">
                {{ chatTarget === 'report_agent' ? 'Report Agentと対話して報告内容を深く理解する' : 'シミュレーション個体と対話して彼らの意見を聞く' }}
              </p>
            </div>
            <div 
          ...
          <div class="survey-setup">
              ...
              <div class="agents-grid">
                ...
                >
                  ...
                  <div class="checkbox-info">
                    ...
                    <span class="checkbox-role">{{ agent.profession || '職業不明' }}</span>
                  </div>
            ...
            <div class="setup-section">
              ...
              <textarea 
                ...
                class="survey-input"
                placeholder="選択した全対象への質問を入力してください..."
                rows="3"
              ></textarea>
            </div>
              ...
              >
                <div class="result-header">
                  ...
                  <div class="result-info">
                    ...
                    <span class="result-role">{{ result.profession || '職業不明' }}</span>
                  </div>
                </div>
...
const sendToReportAgent = async (message) => {
  ...
  if (res.success && res.data) {
    ...
    throw new Error(res.error || 'リクエスト失敗')
  }
}

const sendToAgent = async (message) => {
  if (!selectedAgent.value || selectedAgentIndex.value === null) {
    throw new Error('シミュレーション個体を選択してください')
  }
